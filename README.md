...
| `Authentication failed: network-failure`                                                       | Node cannot reach `serverUrl`. On macOS, allow your terminal under System Settings → Privacy & Security → Local Network, then restart it.                                   |
